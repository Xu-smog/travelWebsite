...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="rootindex.html">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">评论管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form role="form" action=" ${pageContext.request.contextPath}/rootcomment" method="post">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <%int i=0; %>
                        <c:forEach items="${commentAll}" var="U" >
                        <tr>
                            <td class="tc"><input name="id[]" value="59" type="checkbox"></td>
                            <td  id = <%="comment_id"+i%> >${U.comment_id }</td>
                            <td></td>
                            <td>${U.user_id }</td>
                            <td>${U.content }</td>
                            <td>${U.zan_num}</td>
                                ...
                                <script type="text/javascript" src="js/jquery.min.js"></script>
                     			<script type="text/javascript">
                     				document.getElementById('<%="btn2"+i %>').addEventListener('click', function (){
         								// 读取 text
         								var tdobj = document.getElementById('<%="comment_id"+i%>');
										
										$.post("${pageContext.request.contextPath}/commentdelete",
         								{	
         					 				comment_id: tdobj.innerText						      
         								});
