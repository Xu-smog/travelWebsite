    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form role="form" action=" ${pageContext.request.contextPath}/rootuser" method="post">
                    <table class="search-tab">
                        <tr>
                            <th width="70">用户 ID：</th>
                            <td><input class="common-text" placeholder="用户 ID..." name="user_id" value="" id="" type="text"></td>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="btn btn-primary btn2" name="sub" id="btn2" value="删除" type="button">
                                <script type="text/javascript" src="js/jquery.min.js"></script>
                     			<script type="text/javascript">
                     				document.getElementById('btn2').addEventListener('click', function (){
         								// 读取 text
         								var tdobj = document.getElementById('user_id');
										//alert(tdobj.innerText);
										$.post("${pageContext.request.contextPath}/rootuserdelete",
         								{	
         					 				user_id: tdobj.innerText						      
         								});
